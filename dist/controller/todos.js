...
const createToDo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        var todos = yield todos_1.default.create(data);
        return res
            .status(200)
...
const getToDo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        var todos = yield todos_1.default.find({});
...
const updateToDo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        var todos = yield todos_1.default.findByIdAndUpdate(id, req.body, { new: true });
        return res
            .status(200)
...
const deleteToDo = (req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const { id } = req.params;
        var isDeleted = yield todos_1.default.findByIdAndDelete(id);
        if (!isDeleted)
